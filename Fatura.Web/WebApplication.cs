...
namespace Fatura.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class FaturaAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private Fatura.Module.FaturaModule module3;
        private Fatura.Module.Web.FaturaAspNetModule module4;
        ...
        static FaturaAspNetApplication() {
        ...
        #endregion
        public FaturaAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        protected override void CreateDefaultObjectSpaceProvider(CreateCustomObjectSpaceProviderEventArgs args) {
            if(args.Connection != null) {
                args.ObjectSpaceProviders.Add(new EFObjectSpaceProvider(typeof(FaturaDbContext), TypesInfo, null, (DbConnection)args.Connection));
            }
            else {
                args.ObjectSpaceProviders.Add(new EFObjectSpaceProvider(typeof(FaturaDbContext), TypesInfo, null, args.ConnectionString));
            }
            args.ObjectSpaceProviders.Add(new NonPersistentObjectSpaceProvider(TypesInfo, null));
        }
        private void FaturaAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new Fatura.Module.Web.FaturaAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.FaturaAspNetApplication_DatabaseVersionMismatch);
            this.ObjectSpaceCreated += new System.EventHandler<DevExpress.ExpressApp.ObjectSpaceCreatedEventArgs>(this.FaturaAspNetApplication_ObjectSpaceCreated);
            ((System.ComponentModel.ISupportInitialize)(this)).EndInit();

        }
        private void FaturaAspNetApplication_ObjectSpaceCreated(object sender, ObjectSpaceCreatedEventArgs e)
        {
            e.ObjectSpace.Committing += FaturaAspNetApplication_Committing;
        }
        private void FaturaAspNetApplication_Committing(object sender, CancelEventArgs e)
        {
