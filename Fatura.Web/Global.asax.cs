...
namespace Fatura.Web {
    public class Global : System.Web.HttpApplication {
        public Global() {
            ...
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<FaturaDbContext, Fatura.Module.Migrations.Configuration>());
        ...
        protected void Session_Start(Object sender, EventArgs e) {
            Tracing.Initialize();
            WebApplication.SetInstance(Session, new FaturaAspNetApplication());
