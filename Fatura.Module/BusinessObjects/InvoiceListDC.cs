...
{
    [DomainComponent]
    public class InvoiceListDC : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        private void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(propertyName));
        }
        public InvoiceListDC()
        {
            Oid = Guid.NewGuid();
            StartDate= DateTime.Now.Date;
            EndDate= DateTime.Now.Date;   
            //Details = new List<InvoiceListDetailDC>();
        }
        ...
        //[Aggregated]
        //public virtual IList<InvoiceListDetailDC> Details { get; set; }
