...
{
    [DomainComponent]
    public class InvoiceListDetailDC : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        private void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(propertyName));
        }
        public InvoiceListDetailDC()
        {
            Oid = Guid.NewGuid();
        }
        ...
        [Browsable(false)]
        public virtual InvoiceListDC InvoiceListDC { get; set; }
